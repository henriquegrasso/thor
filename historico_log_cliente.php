...
<div id = "content">
  <?php		
		if($con){		
			$sql = "select * from log_requisito inner join usuario on id_user = usuario.id where id_user =" .$_POST['cmbCliente'];
			$rs = mysqli_query($con, $sql);
			if($rs){?>
				<h2> Histórico de Alterações dos Requisitos do Cliente </h2><center>
				<table  align = "center">
					<tr align = "center">
						<th>ID</th>
